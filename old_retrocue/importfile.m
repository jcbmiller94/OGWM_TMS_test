...
%   data = IMPORTFILE(FILENAME) Reads data
...
%
% Example:
%   data = importfile('OGWM_retrocue_task_v05_OGWM_101_sess2_pfc.txt', 2, 217);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/08/14 11:57:44
...
for col=[1,4,5,6,9,10,17,24,29,30]
...
rawNumericColumns = raw(:, [1,4,5,6,9,10,17,24,29,30]);
rawCellColumns = raw(:, [2,3,7,8,11,12,13,14,15,16,18,19,20,21,22,23,25,26,27,28]);
